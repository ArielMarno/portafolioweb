        ...
        <main>
          ...
          <article className='restaurant'>
            ...
            <section>
              ...
              <p>Diseño moderno y elegante para un restaurante de alta cocina. Cuenta con un navegador en la parte superior para recorrer la página de una manera más dinámica. Distintas secciones donde se puede encontrar: los especiales del día, carrusel de imágenes vinculado a su Instagram, un video mostrando el ambiente reconfortante del lugar y también una llamada a la acción donde el potencial cliente puede suscribirse para recibir novedades.</p>
              <div className='buttons'>
                <a href="https://figmarestaurantapp.000webhostapp.com/" target="_blank" rel="noopener noreferrer" className='paginaweb'>PAGINA WEB</a>
                <a href="https://github.com/ArielMarno/FineDiningRestaurantApp" target="_blank" rel="noopener noreferrer" className='github'>REPOSITORIO</a>
                <a href="https://www.figma.com/file/yvClSI9AZBRX8UaaGEByF3/Modern-UI%2FUX%3A-Gericht?type=design&node-id=0-1&mode=design&t=HrlI32Pxpe5JdAD2-0" target="_blank" rel="noopener noreferrer" className='diseño'>DISEÑO FIGMA</a>
              </div>
            </section>
          ...
          <section>
              ...
              <div className='buttons'>
                <a href="https://gpt-4-ai.000webhostapp.com/" target="_blank" rel="noopener noreferrer" className='paginaweb'>PAGINA WEB</a>
                <a href="https://github.com/ArielMarno/GPT-4" target="_blank" rel="noopener noreferrer" className='github'>REPOSITORIO</a>
                <a href="https://www.figma.com/file/lz9lLpFHMxHm2odnwM3R0z/gpt3?type=design&node-id=0-1&mode=design&t=5EVD7mCtolYSN747-0" target="_blank" rel="noopener noreferrer" className='diseño'>DISEÑO FIGMA</a>
              </div>
            </section>
          ...
          <article className='agencia'>
            ...
            <section>
              ...
              <div className='buttons'>
                <a href="https://sunfloweragencia.com/" target="_blank" rel="noopener noreferrer" className='paginaweb'>PAGINA WEB</a>
                <a href="https://github.com/ArielMarno/sunflower" target="_blank" rel="noopener noreferrer" className='github'>REPOSITORIO</a>
                <a href="https://www.figma.com/file/8Tp6eR73ilxO5CgIxko31z/Sunflower?type=design&node-id=0-1&mode=design&t=ZQOVwpgaOvCao126-0" target="_blank" rel="noopener noreferrer" className='diseño'>DISEÑO FIGMA</a>
              </div>
            </section>
          ...
          <article className='weather'>
           ...
           <section>
              ...
              <div className='buttons'>
                <a href="https://weatherwebside.000webhostapp.com/" target="_blank" rel="noopener noreferrer" className='paginaweb'>PAGINA WEB</a>
                <a href="https://github.com/ArielMarno/weather-app" target="_blank" rel="noopener noreferrer" className='github'>REPOSITORIO</a>
                <a href="https://www.behance.net/gallery/174927383/Weather-forecast-website" target="_blank" rel="noopener noreferrer" className='diseño'>DISEÑO BEHANCE</a>
              </div>
            </section>
